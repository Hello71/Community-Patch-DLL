...
#define SDL_INIT_GAMECONTROLLER 0x00002000u
    ...
    if (new_flags != flags)
        fputs("[CBP] Disabling joystick/haptic/controller support in SDL\n", stderr);
...
static __attribute__((used)) void hook() {
    ...
    size_t new_sqlite_version_size;
    ...
    if (!(no_system && no_system[0])) {
        fputs("[CBP] Updating statically linked libraries, export CBP_NO_SYSTEM=1 to disable\n", stderr);
...
static void init() {
    static char msg[] = "[CBP] Configuring CBP hooks...\n";
